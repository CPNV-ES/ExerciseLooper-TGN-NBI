                ...
                <tbody>
                    <?php foreach ($data['exercisesAnswering'] as $exAnswer) : ?>
                        <tr>
                            ...
                            <td>
                                <a title="Exercise results" href="<?= $data['router']->getUrl('results', ["id" => $exAnswer->getID()]) ?>"><i class="fa fa-chart-bar"></i></a>
                ...
                <tbody>
                    <?php foreach ($data['exercisesClosed'] as $exClosed) : ?>
                        <tr>
                            ...
                            <td>
                                <a title="Show results" href="<?= $data['router']->getUrl('results', ["id" => $exClosed->getID()]) ?>"><i class="fa fa-chart-bar"></i></a>
